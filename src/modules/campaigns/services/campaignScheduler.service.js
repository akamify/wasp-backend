    ...
    return Array.isArray(recipients)
        ? recipients
            .map((recipient) => ({
                ...
                headerLocation: recipient?.headerLocation && typeof recipient.headerLocation === "object" ? {
                    latitude: Number(recipient.headerLocation.latitude),
                    longitude: Number(recipient.headerLocation.longitude),
                    name: String(recipient.headerLocation.name || ""),
                    address: String(recipient.headerLocation.address || ""),
                } : undefined,
