...
const BillingSettingsSchema = new mongoose.Schema(
  {
    ...
    freePlan: {
      ...
      limits: {
        ...
        maxTags: { type: Number, default: 10, min: 0 },
        maxCustomAttributes: { type: Number, default: 5, min: 0 },
        maxWebhooks: { type: Number, default: 0, min: 0 },
        messageRatePerSec: { type: Number, default: 5, min: 0 },
        maxFlows: { type: Number, default: 0, min: 0 },
        maxTeams: { type: Number, default: 0, min: 0 },
        maxApiKeys: { type: Number, default: 0, min: 0 },
        maxStorageMb: { type: Number, default: 0, min: 0 },
        maxProjects: { type: Number, default: 0, min: 0 },
        maxMediaSizeMb: { type: Number, default: 0, min: 0 },
        dailyMessageLimit: { type: Number, default: 0, min: 0 },
      },
    },
