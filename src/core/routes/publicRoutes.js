...
const { academyHome, academyArticle, academySearch, academyRelated, docsLinkIndex } = require("@modules/public/controllers/publicDocs.controller");
...
router.get("/docs/links", asyncHandler(docsLinkIndex));
